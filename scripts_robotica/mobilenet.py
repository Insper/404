...
while(True):
    ...
    topico_imagem = "/camera/color/image_raw/compressed" 
    recebedor = rospy.Subscriber(topico_imagem, CompressedImage, detect, queue_size=4, buff_size = 2**24)
    
    result_frame, result_tuples = detect(recebedor)
